...
public class AssetAuditFinalApprovalsController(MediatR.ISender sender) : ControllerBase
{
    ...
    [HasPermission(Permissions.AssetAuditFinalApprovals.View)]
    [HttpGet]
    ...
    [HasPermission(Permissions.AssetAuditFinalApprovals.Create)]
    [HttpPost]
    ...
    [HasPermission(Permissions.AssetAuditFinalApprovals.Update)]
    [HttpPut("{id}")]
    ...
    [HasPermission(Permissions.AssetAuditFinalApprovals.Delete)]
    [HttpDelete("{id}")]
