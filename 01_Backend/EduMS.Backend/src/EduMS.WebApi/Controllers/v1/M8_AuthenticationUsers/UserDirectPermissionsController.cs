...
public class UserDirectPermissionsController(MediatR.ISender sender) : ControllerBase
{
    ...
    [HasPermission(Permissions.UserDirectPermissions.View)]
    [HttpGet]
    ...
    [HasPermission(Permissions.UserDirectPermissions.Create)]
    [HttpPost]
    ...
    [HasPermission(Permissions.UserDirectPermissions.Update)]
    [HttpPut("{id}")]
    ...
    [HasPermission(Permissions.UserDirectPermissions.Delete)]
    [HttpDelete("{id}")]
