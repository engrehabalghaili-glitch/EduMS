...
public class CommitteeMembersController(MediatR.ISender sender) : ControllerBase
{
    ...
    [HasPermission(Permissions.CommitteeMembers.View)]
    [HttpGet]
    ...
    [HasPermission(Permissions.CommitteeMembers.Create)]
    [HttpPost]
    ...
    [HasPermission(Permissions.CommitteeMembers.Update)]
    [HttpPut("{id}")]
    ...
    [HasPermission(Permissions.CommitteeMembers.Delete)]
    [HttpDelete("{id}")]
