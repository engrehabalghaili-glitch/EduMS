...
public class EmployeePayrollsController(MediatR.ISender sender) : ControllerBase
{
    ...
    [HasPermission(Permissions.EmployeePayrolls.View)]
    [HttpGet]
    ...
    [HasPermission(Permissions.EmployeePayrolls.Create)]
    [HttpPost]
    ...
    [HasPermission(Permissions.EmployeePayrolls.Update)]
    [HttpPut("{id}")]
    ...
    [HasPermission(Permissions.EmployeePayrolls.Delete)]
    [HttpDelete("{id}")]
