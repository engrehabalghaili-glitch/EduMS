...
public class StudentTransportationSubscriptionsController(MediatR.ISender sender) : ControllerBase
{
    ...
    [HasPermission(Permissions.StudentTransportationSubscriptions.View)]
    [HttpGet]
    ...
    [HasPermission(Permissions.StudentTransportationSubscriptions.Create)]
    [HttpPost]
    ...
    [HasPermission(Permissions.StudentTransportationSubscriptions.Update)]
    [HttpPut("{id}")]
    ...
    [HasPermission(Permissions.StudentTransportationSubscriptions.Delete)]
    [HttpDelete("{id}")]
