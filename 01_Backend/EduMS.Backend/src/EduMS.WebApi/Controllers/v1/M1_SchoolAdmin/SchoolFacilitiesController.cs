...
public class SchoolFacilitiesController(MediatR.ISender sender) : ControllerBase
{
    ...
    [HasPermission(Permissions.SchoolFacilities.View)]
    ...
    [HasPermission(Permissions.SchoolFacilities.Create)]
    [HttpPost]
    ...
    [HasPermission(Permissions.SchoolFacilities.Update)]
    [HttpPut("{id}")]
    ...
    [HasPermission(Permissions.SchoolFacilities.Delete)]
    [HttpDelete("{id}")]
