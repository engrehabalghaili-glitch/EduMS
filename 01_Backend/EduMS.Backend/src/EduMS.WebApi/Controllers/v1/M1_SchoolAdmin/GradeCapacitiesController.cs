...
public class GradeCapacitiesController(MediatR.ISender sender) : ControllerBase
{
    ...
    [HasPermission(Permissions.GradeCapacities.View)]
    ...
    [HasPermission(Permissions.GradeCapacities.Create)]
    [HttpPost]
    ...
    [HasPermission(Permissions.GradeCapacities.Update)]
    [HttpPut("{id}")]
    ...
    [HasPermission(Permissions.GradeCapacities.Delete)]
    [HttpDelete("{id}")]
