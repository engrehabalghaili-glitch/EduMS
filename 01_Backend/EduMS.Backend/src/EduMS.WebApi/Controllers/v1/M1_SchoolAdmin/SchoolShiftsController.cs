...
public class SchoolShiftsController(MediatR.ISender sender) : ControllerBase
{
    ...
    [HasPermission(Permissions.SchoolShifts.View)]
    ...
    [HasPermission(Permissions.SchoolShifts.Create)]
    [HttpPost]
    ...
    [HasPermission(Permissions.SchoolShifts.Update)]
    [HttpPut("{id}")]
    ...
    [HasPermission(Permissions.SchoolShifts.Delete)]
    [HttpDelete("{id}")]
