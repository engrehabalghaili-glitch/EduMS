...
public class SchoolFacilityMaintenanceLogsController(MediatR.ISender sender) : ControllerBase
{
    ...
    [HasPermission(Permissions.SchoolFacilityMaintenanceLogs.View)]
    ...
    [HasPermission(Permissions.SchoolFacilityMaintenanceLogs.Create)]
    [HttpPost]
    ...
    [HasPermission(Permissions.SchoolFacilityMaintenanceLogs.Update)]
    [HttpPut("{id}")]
    ...
    [HasPermission(Permissions.SchoolFacilityMaintenanceLogs.Delete)]
    [HttpDelete("{id}")]
