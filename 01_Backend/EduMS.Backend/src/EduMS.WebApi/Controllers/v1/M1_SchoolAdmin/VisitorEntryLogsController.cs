...
public class VisitorEntryLogsController(MediatR.ISender sender) : ControllerBase
{
    ...
    [HasPermission(Permissions.VisitorEntryLogs.View)]
    ...
    [HasPermission(Permissions.VisitorEntryLogs.Create)]
    [HttpPost]
    ...
    [HasPermission(Permissions.VisitorEntryLogs.Update)]
    [HttpPut("{id}")]
    ...
    [HasPermission(Permissions.VisitorEntryLogs.Delete)]
    [HttpDelete("{id}")]
