...
public class SchoolLevelsController(MediatR.ISender sender) : ControllerBase
{
    ...
    [HasPermission(Permissions.SchoolLevels.View)]
    ...
    [HasPermission(Permissions.SchoolLevels.Create)]
    [HttpPost]
    ...
    [HasPermission(Permissions.SchoolLevels.Update)]
    [HttpPut("{id}")]
    ...
    [HasPermission(Permissions.SchoolLevels.Delete)]
    [HttpDelete("{id}")]
