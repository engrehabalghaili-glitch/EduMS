...
public class SchoolAccreditationLogsController(MediatR.ISender sender) : ControllerBase
{
    ...
    [HasPermission(Permissions.SchoolAccreditationLogs.View)]
    ...
    [HasPermission(Permissions.SchoolAccreditationLogs.Create)]
    [HttpPost]
    ...
    [HasPermission(Permissions.SchoolAccreditationLogs.Update)]
    [HttpPut("{id}")]
    ...
    [HasPermission(Permissions.SchoolAccreditationLogs.Delete)]
    [HttpDelete("{id}")]
