...
public class SchoolSemestersController(MediatR.ISender sender) : ControllerBase
{
    ...
    [HasPermission(Permissions.SchoolSemesters.View)]
    ...
    [HasPermission(Permissions.SchoolSemesters.Create)]
    [HttpPost]
    ...
    [HasPermission(Permissions.SchoolSemesters.Update)]
    [HttpPut("{id}")]
    ...
    [HasPermission(Permissions.SchoolSemesters.Delete)]
    [HttpDelete("{id}")]
