...
namespace EduMS.IntegrationTests.ApiEndpoints.M2_StudentAffairs;

[Collection("IntegrationTests")]
public class StudentsEndpointTests : ApiIntegrationTestBase
{
    public StudentsEndpointTests(CustomWebApplicationFactory<Program> factory) : base(factory)
    {
    }
