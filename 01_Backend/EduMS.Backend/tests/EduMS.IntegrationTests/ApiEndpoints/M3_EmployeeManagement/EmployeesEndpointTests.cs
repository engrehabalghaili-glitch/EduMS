...
namespace EduMS.IntegrationTests.ApiEndpoints.M3_EmployeeManagement;

[Collection("IntegrationTests")]
public class EmployeesEndpointTests : ApiIntegrationTestBase
{
    public EmployeesEndpointTests(CustomWebApplicationFactory<Program> factory) : base(factory)
    {
    }
