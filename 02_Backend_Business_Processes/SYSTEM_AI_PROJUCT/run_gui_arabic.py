# -*- coding: utf-8 -*-
"""
Arabic GUI Runner - Start GUI with Arabic interface
"""
...
def run_gui():
    ...
    if not os.path.exists('gui_app_arabic_true_final_v3.py'):
        print("Error: gui_app_arabic_true_final_v3.py not found!")
    ...
    try:
        subprocess.run([
            sys.executable, "-m", "streamlit", "run", "gui_app_arabic_true_final_v3.py",
            "--server.port", "8501",
