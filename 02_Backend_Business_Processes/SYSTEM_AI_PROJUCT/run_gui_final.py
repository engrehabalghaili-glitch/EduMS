# -*- coding: utf-8 -*-
"""
Final GUI Runner - Start GUI with Arabic interface
"""
...
def run_gui():
    ...
    if not os.path.exists('gui_app_arabic_final.py'):
        print("Error: gui_app_arabic_final.py not found!")
    ...
    try:
        subprocess.run([
            sys.executable, "-m", "streamlit", "run", "gui_app_arabic_final.py",
            "--server.port", "8501",
