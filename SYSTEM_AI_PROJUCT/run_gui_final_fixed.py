# -*- coding: utf-8 -*-
"""
Final GUI Runner - Start GUI with Arabic interface and fixed model paths
"""
...
def run_gui():
    ...
    if not os.path.exists('gui_app_arabic_final_fixed.py'):
        print("Error: gui_app_arabic_final_fixed.py not found!")
    ...
    try:
        subprocess.run([
            sys.executable, "-m", "streamlit", "run", "gui_app_arabic_final_fixed.py",
            "--server.port", "8501",
