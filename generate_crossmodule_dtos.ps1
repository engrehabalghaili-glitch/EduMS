param (
    [string]$ModuleName = "CrossModule_Integrations"
)

$srcPath = "h:\EduMS\EduMS.Backend\src"
$entitiesPath = "$srcPath\EduMS.Domain\Entities\CrossModule_RelationalIntegration.cs"
...
$files = @(Get-Item -Path $entitiesPath)
