...
[Authorize]
public class SubmittedStatisticsesController : ControllerBase
{
    private readonly IMediator _mediator;

    public SubmittedStatisticsesController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllSubmittedStatisticsesQuery());
    ...
    {
        var result = await _mediator.Send(new GetSubmittedStatisticsByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateSubmittedStatisticsCommand { Dto = dto });
