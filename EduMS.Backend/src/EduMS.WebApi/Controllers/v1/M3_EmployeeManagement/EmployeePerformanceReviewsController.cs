...
[Authorize]
public class EmployeePerformanceReviewsController : ControllerBase
{
    private readonly IMediator _mediator;

    public EmployeePerformanceReviewsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllEmployeePerformanceReviewsQuery());
    ...
    {
        var result = await _mediator.Send(new GetEmployeePerformanceReviewByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateEmployeePerformanceReviewCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateEmployeePerformanceReviewCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteEmployeePerformanceReviewCommand { Id = id });
