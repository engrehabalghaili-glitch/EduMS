...
[Authorize]
public class EmployeeAdditionalTasksController : ControllerBase
{
    private readonly IMediator _mediator;

    public EmployeeAdditionalTasksController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllEmployeeAdditionalTasksQuery());
    ...
    {
        var result = await _mediator.Send(new GetEmployeeAdditionalTaskByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateEmployeeAdditionalTaskCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateEmployeeAdditionalTaskCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteEmployeeAdditionalTaskCommand { Id = id });
