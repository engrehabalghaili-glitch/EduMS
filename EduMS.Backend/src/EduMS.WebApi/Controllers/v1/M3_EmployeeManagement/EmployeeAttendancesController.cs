...
public class EmployeeAttendancesController : ControllerBase
{
    ...
    public EmployeeAttendancesController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllEmployeeAttendancesQuery());
    ...
    {
        var result = await _mediator.Send(new GetEmployeeAttendanceByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateEmployeeAttendanceCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateEmployeeAttendanceCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteEmployeeAttendanceCommand { Id = id });
