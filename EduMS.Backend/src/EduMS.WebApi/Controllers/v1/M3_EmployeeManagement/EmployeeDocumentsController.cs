...
public class EmployeeDocumentsController : ControllerBase
{
    ...
    {
        var result = await _mediator.Send(new GetAllEmployeeDocumentsQuery());
    ...
    {
        var result = await _mediator.Send(new GetEmployeeDocumentByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateEmployeeDocumentCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateEmployeeDocumentCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteEmployeeDocumentCommand { Id = id });
