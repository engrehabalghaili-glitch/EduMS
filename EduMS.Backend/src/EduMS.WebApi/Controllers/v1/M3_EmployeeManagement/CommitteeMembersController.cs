...
public class CommitteeMembersController : ControllerBase
{
    ...
    public CommitteeMembersController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllCommitteeMembersQuery());
    ...
    {
        var result = await _mediator.Send(new GetCommitteeMemberByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateCommitteeMemberCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateCommitteeMemberCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteCommitteeMemberCommand { Id = id });
