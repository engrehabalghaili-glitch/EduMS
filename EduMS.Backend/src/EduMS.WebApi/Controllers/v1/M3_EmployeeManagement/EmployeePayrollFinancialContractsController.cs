...
[Authorize]
public class EmployeePayrollFinancialContractsController : ControllerBase
{
    private readonly IMediator _mediator;

    public EmployeePayrollFinancialContractsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllEmployeePayrollFinancialContractsQuery());
    ...
    {
        var result = await _mediator.Send(new GetEmployeePayrollFinancialContractByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateEmployeePayrollFinancialContractCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateEmployeePayrollFinancialContractCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteEmployeePayrollFinancialContractCommand { Id = id });
