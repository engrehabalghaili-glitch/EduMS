...
[Authorize]
public class EmployeeMeetingsController : ControllerBase
{
    private readonly IMediator _mediator;

    public EmployeeMeetingsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllEmployeeMeetingsQuery());
    ...
    {
        var result = await _mediator.Send(new GetEmployeeMeetingByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateEmployeeMeetingCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateEmployeeMeetingCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteEmployeeMeetingCommand { Id = id });
