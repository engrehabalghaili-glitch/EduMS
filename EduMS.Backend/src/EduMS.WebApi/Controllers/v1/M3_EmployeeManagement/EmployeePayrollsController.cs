...
public class EmployeePayrollsController : ControllerBase
{
    ...
    public EmployeePayrollsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllEmployeePayrollsQuery());
    ...
    {
        var result = await _mediator.Send(new GetEmployeePayrollByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateEmployeePayrollCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateEmployeePayrollCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteEmployeePayrollCommand { Id = id });
