...
[Authorize]
public class EmployeeInternalTransfersController : ControllerBase
{
    private readonly IMediator _mediator;

    public EmployeeInternalTransfersController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllEmployeeInternalTransfersQuery());
    ...
    {
        var result = await _mediator.Send(new GetEmployeeInternalTransferByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateEmployeeInternalTransferCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateEmployeeInternalTransferCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteEmployeeInternalTransferCommand { Id = id });
