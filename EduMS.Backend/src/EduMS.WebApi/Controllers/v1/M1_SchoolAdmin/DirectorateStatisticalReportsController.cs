...
[Authorize]
public class DirectorateStatisticalReportsController : ControllerBase
{
    private readonly IMediator _mediator;

    public DirectorateStatisticalReportsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllDirectorateStatisticalReportsQuery());
    ...
    {
        var result = await _mediator.Send(new GetDirectorateStatisticalReportByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateDirectorateStatisticalReportCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateDirectorateStatisticalReportCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteDirectorateStatisticalReportCommand { Id = id });
