...
public class SchoolLevelsController : ControllerBase
{
    ...
    public SchoolLevelsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllSchoolLevelsQuery());
    ...
    {
        var result = await _mediator.Send(new GetSchoolLevelByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateSchoolLevelCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateSchoolLevelCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteSchoolLevelCommand { Id = id });
