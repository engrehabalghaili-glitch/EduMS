...
[Authorize]
public class SchoolAcademicYearsController : ControllerBase
{
    private readonly IMediator _mediator;

    public SchoolAcademicYearsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllSchoolAcademicYearsQuery());
    ...
    {
        var result = await _mediator.Send(new GetSchoolAcademicYearByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateSchoolAcademicYearCommand { Dto = dto });
    ...
    public async Task<IActionResult> Update(long id, [FromBody] UpdateSchoolAcademicYearDto dto)
    {
        ...
        await _mediator.Send(new UpdateSchoolAcademicYearCommand { Dto = dto });
    ...
    {
        await _mediator.Send(new DeleteSchoolAcademicYearCommand { Id = id });
