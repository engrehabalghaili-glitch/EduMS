...
[Authorize]
public class DirectorateLegalCaseLogsController : ControllerBase
{
    private readonly IMediator _mediator;

    public DirectorateLegalCaseLogsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllDirectorateLegalCaseLogsQuery());
    ...
    {
        var result = await _mediator.Send(new GetDirectorateLegalCaseLogByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateDirectorateLegalCaseLogCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateDirectorateLegalCaseLogCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteDirectorateLegalCaseLogCommand { Id = id });
