...
[Authorize]
public class AcademicBranchConfigLogsController : ControllerBase
{
    private readonly IMediator _mediator;

    public AcademicBranchConfigLogsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllAcademicBranchConfigLogsQuery());
    ...
    {
        var result = await _mediator.Send(new GetAcademicBranchConfigLogByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateAcademicBranchConfigLogCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateAcademicBranchConfigLogCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteAcademicBranchConfigLogCommand { Id = id });
