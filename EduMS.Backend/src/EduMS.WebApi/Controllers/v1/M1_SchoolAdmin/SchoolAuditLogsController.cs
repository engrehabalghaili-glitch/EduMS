...
[Authorize]
public class SchoolAuditLogsController : ControllerBase
{
    private readonly IMediator _mediator;

    public SchoolAuditLogsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllSchoolAuditLogsQuery());
    ...
    {
        var result = await _mediator.Send(new GetSchoolAuditLogByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateSchoolAuditLogCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateSchoolAuditLogCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteSchoolAuditLogCommand { Id = id });
