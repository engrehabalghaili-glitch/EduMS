...
[Authorize]
public class SchoolOperationalBudgetLogsController : ControllerBase
{
    private readonly IMediator _mediator;

    public SchoolOperationalBudgetLogsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllSchoolOperationalBudgetLogsQuery());
    ...
    {
        var result = await _mediator.Send(new GetSchoolOperationalBudgetLogByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateSchoolOperationalBudgetLogCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateSchoolOperationalBudgetLogCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteSchoolOperationalBudgetLogCommand { Id = id });
