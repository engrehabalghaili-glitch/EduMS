...
[Authorize]
public class SchoolAccreditationLogsController : ControllerBase
{
    private readonly IMediator _mediator;

    public SchoolAccreditationLogsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllSchoolAccreditationLogsQuery());
    ...
    {
        var result = await _mediator.Send(new GetSchoolAccreditationLogByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateSchoolAccreditationLogCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateSchoolAccreditationLogCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteSchoolAccreditationLogCommand { Id = id });
