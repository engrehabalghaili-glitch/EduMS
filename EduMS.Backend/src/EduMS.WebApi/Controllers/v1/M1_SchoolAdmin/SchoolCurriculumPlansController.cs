...
[Authorize]
public class SchoolCurriculumPlansController : ControllerBase
{
    private readonly IMediator _mediator;

    public SchoolCurriculumPlansController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllSchoolCurriculumPlansQuery());
    ...
    {
        var result = await _mediator.Send(new GetSchoolCurriculumPlanByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateSchoolCurriculumPlanCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateSchoolCurriculumPlanCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteSchoolCurriculumPlanCommand { Id = id });
