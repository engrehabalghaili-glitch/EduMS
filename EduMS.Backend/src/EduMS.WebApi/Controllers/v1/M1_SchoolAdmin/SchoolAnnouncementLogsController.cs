...
[Authorize]
public class SchoolAnnouncementLogsController : ControllerBase
{
    private readonly IMediator _mediator;

    public SchoolAnnouncementLogsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllSchoolAnnouncementLogsQuery());
    ...
    {
        var result = await _mediator.Send(new GetSchoolAnnouncementLogByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateSchoolAnnouncementLogCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateSchoolAnnouncementLogCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteSchoolAnnouncementLogCommand { Id = id });
