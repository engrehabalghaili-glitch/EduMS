...
[Authorize]
public class GradeCapacitiesController : ControllerBase
{
    private readonly IMediator _mediator;

    public GradeCapacitiesController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllGradeCapacitiesQuery());
    ...
    {
        var result = await _mediator.Send(new GetGradeCapacityByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateGradeCapacityCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateGradeCapacityCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteGradeCapacityCommand { Id = id });
