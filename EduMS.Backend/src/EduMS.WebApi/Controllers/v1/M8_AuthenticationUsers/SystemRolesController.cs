...
public class SystemRolesController : ControllerBase
{
    ...
    {
        var result = await _mediator.Send(new GetAllSystemRolesQuery());
    ...
    {
        var result = await _mediator.Send(new GetSystemRoleByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateSystemRoleCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateSystemRoleCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteSystemRoleCommand { Id = id });
