...
[Authorize]
public class BehaviorPermissionsController : ControllerBase
{
    private readonly IMediator _mediator;

    public BehaviorPermissionsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllBehaviorPermissionsQuery());
    ...
    {
        var result = await _mediator.Send(new GetBehaviorPermissionByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateBehaviorPermissionCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateBehaviorPermissionCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteBehaviorPermissionCommand { Id = id });
