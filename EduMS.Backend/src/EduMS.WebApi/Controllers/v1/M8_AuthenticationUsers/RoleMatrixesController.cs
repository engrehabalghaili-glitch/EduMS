...
[Authorize]
public class RoleMatrixesController : ControllerBase
{
    private readonly IMediator _mediator;

    public RoleMatrixesController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllRoleMatrixesQuery());
    ...
    {
        var result = await _mediator.Send(new GetRoleMatrixByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateRoleMatrixCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateRoleMatrixCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteRoleMatrixCommand { Id = id });
