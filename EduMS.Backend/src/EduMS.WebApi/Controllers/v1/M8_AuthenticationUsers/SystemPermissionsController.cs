...
public class SystemPermissionsController : ControllerBase
{
    ...
    {
        var result = await _mediator.Send(new GetAllSystemPermissionsQuery());
    ...
    {
        var result = await _mediator.Send(new GetSystemPermissionByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateSystemPermissionCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateSystemPermissionCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteSystemPermissionCommand { Id = id });
