...
public class UserRoleAssignmentsController : ControllerBase
{
    ...
    public UserRoleAssignmentsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllUserRoleAssignmentsQuery());
    ...
    {
        var result = await _mediator.Send(new GetUserRoleAssignmentByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateUserRoleAssignmentCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateUserRoleAssignmentCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteUserRoleAssignmentCommand { Id = id });
