...
[Authorize]
public class BehaviorPermissionMatrixesController : ControllerBase
{
    private readonly IMediator _mediator;

    public BehaviorPermissionMatrixesController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllBehaviorPermissionMatrixesQuery());
    ...
    {
        var result = await _mediator.Send(new GetBehaviorPermissionMatrixByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateBehaviorPermissionMatrixCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateBehaviorPermissionMatrixCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteBehaviorPermissionMatrixCommand { Id = id });
