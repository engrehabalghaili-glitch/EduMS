...
public class SystemAuditLogsController : ControllerBase
{
    ...
    {
        var result = await _mediator.Send(new GetAllSystemAuditLogsQuery());
    ...
    {
        var result = await _mediator.Send(new GetSystemAuditLogByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateSystemAuditLogCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateSystemAuditLogCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteSystemAuditLogCommand { Id = id });
