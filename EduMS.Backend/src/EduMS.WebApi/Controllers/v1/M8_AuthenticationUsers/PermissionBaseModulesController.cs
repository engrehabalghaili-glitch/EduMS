...
[Authorize]
public class PermissionBaseModulesController : ControllerBase
{
    private readonly IMediator _mediator;

    public PermissionBaseModulesController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllPermissionBaseModulesQuery());
    ...
    {
        var result = await _mediator.Send(new GetPermissionBaseModuleByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreatePermissionBaseModuleCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdatePermissionBaseModuleCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeletePermissionBaseModuleCommand { Id = id });
