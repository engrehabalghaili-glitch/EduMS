...
public class PayrollDetailsController : ControllerBase
{
    ...
    public PayrollDetailsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllPayrollDetailsQuery());
    ...
    {
        var result = await _mediator.Send(new GetPayrollDetailByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreatePayrollDetailCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdatePayrollDetailCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeletePayrollDetailCommand { Id = id });
