...
public class PaymentVouchersController : ControllerBase
{
    ...
    {
        var result = await _mediator.Send(new GetPaymentVoucherByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreatePaymentVoucherCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdatePaymentVoucherCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeletePaymentVoucherCommand { Id = id });
