...
public class JournalEntryLinesController : ControllerBase
{
    ...
    public JournalEntryLinesController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllJournalEntryLinesQuery());
    ...
    {
        var result = await _mediator.Send(new GetJournalEntryLineByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateJournalEntryLineCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateJournalEntryLineCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteJournalEntryLineCommand { Id = id });
