...
public class FeePaymentsController : ControllerBase
{
    ...
    public FeePaymentsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllFeePaymentsQuery());
    ...
    {
        var result = await _mediator.Send(new GetFeePaymentByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateFeePaymentCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateFeePaymentCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteFeePaymentCommand { Id = id });
