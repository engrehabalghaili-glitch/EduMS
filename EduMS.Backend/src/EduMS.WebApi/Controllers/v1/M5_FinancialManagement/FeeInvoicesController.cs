...
public class FeeInvoicesController : ControllerBase
{
    ...
    public FeeInvoicesController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllFeeInvoicesQuery());
    ...
    {
        var result = await _mediator.Send(new GetFeeInvoiceByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateFeeInvoiceCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateFeeInvoiceCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteFeeInvoiceCommand { Id = id });
