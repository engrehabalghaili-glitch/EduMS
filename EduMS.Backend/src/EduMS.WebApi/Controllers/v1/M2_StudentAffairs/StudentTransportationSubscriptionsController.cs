...
[Authorize]
public class StudentTransportationSubscriptionsController : ControllerBase
{
    private readonly IMediator _mediator;

    public StudentTransportationSubscriptionsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllStudentTransportationSubscriptionsQuery());
    ...
    {
        var result = await _mediator.Send(new GetStudentTransportationSubscriptionByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateStudentTransportationSubscriptionCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateStudentTransportationSubscriptionCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteStudentTransportationSubscriptionCommand { Id = id });
