...
public class BehavioralLogsController : ControllerBase
{
    ...
    public BehavioralLogsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllBehavioralLogsQuery());
    ...
    {
        var result = await _mediator.Send(new GetBehavioralLogByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateBehavioralLogCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateBehavioralLogCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteBehavioralLogCommand { Id = id });
