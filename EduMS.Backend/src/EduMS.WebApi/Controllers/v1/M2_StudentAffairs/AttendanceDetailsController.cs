...
public class AttendanceDetailsController : ControllerBase
{
    ...
    public AttendanceDetailsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllAttendanceDetailsQuery());
    ...
    {
        var result = await _mediator.Send(new GetAttendanceDetailByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateAttendanceDetailCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateAttendanceDetailCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteAttendanceDetailCommand { Id = id });
