...
[Authorize]
public class StudentExitClearancesController : ControllerBase
{
    private readonly IMediator _mediator;

    public StudentExitClearancesController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllStudentExitClearancesQuery());
    ...
    {
        var result = await _mediator.Send(new GetStudentExitClearanceByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateStudentExitClearanceCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateStudentExitClearanceCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteStudentExitClearanceCommand { Id = id });
