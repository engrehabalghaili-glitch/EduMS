...
[Authorize]
public class StudentTransferLogsController : ControllerBase
{
    private readonly IMediator _mediator;

    public StudentTransferLogsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllStudentTransferLogsQuery());
    ...
    {
        var result = await _mediator.Send(new GetStudentTransferLogByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateStudentTransferLogCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateStudentTransferLogCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteStudentTransferLogCommand { Id = id });
