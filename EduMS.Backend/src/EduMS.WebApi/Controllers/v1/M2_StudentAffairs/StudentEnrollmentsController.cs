...
public class StudentEnrollmentsController : ControllerBase
{
    ...
    {
        var result = await _mediator.Send(new GetAllStudentEnrollmentsQuery());
    ...
    {
        var result = await _mediator.Send(new GetStudentEnrollmentByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateStudentEnrollmentCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateStudentEnrollmentCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteStudentEnrollmentCommand { Id = id });
