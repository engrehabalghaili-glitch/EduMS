...
public class ClassSectionsController : ControllerBase
{
    ...
    {
        var result = await _mediator.Send(new GetAllClassSectionsQuery());
    ...
    {
        var result = await _mediator.Send(new GetClassSectionByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateClassSectionCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateClassSectionCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteClassSectionCommand { Id = id });
