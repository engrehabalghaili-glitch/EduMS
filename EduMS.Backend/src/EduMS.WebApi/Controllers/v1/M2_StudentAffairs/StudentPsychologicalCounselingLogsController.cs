...
[Authorize]
public class StudentPsychologicalCounselingLogsController : ControllerBase
{
    private readonly IMediator _mediator;

    public StudentPsychologicalCounselingLogsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllStudentPsychologicalCounselingLogsQuery());
    ...
    {
        var result = await _mediator.Send(new GetStudentPsychologicalCounselingLogByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateStudentPsychologicalCounselingLogCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateStudentPsychologicalCounselingLogCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteStudentPsychologicalCounselingLogCommand { Id = id });
