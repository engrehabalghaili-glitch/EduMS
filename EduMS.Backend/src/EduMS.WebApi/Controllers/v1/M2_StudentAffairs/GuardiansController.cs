...
public class GuardiansController : ControllerBase
{
    ...
    {
        var result = await _mediator.Send(new GetGuardianByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateGuardianCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateGuardianCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteGuardianCommand { Id = id });
