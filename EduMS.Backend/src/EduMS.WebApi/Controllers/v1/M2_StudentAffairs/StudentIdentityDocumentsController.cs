...
[Authorize]
public class StudentIdentityDocumentsController : ControllerBase
{
    private readonly IMediator _mediator;

    public StudentIdentityDocumentsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllStudentIdentityDocumentsQuery());
    ...
    {
        var result = await _mediator.Send(new GetStudentIdentityDocumentByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateStudentIdentityDocumentCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateStudentIdentityDocumentCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteStudentIdentityDocumentCommand { Id = id });
