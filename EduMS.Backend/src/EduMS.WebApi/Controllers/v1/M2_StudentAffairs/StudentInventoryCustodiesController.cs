...
[Authorize]
public class StudentInventoryCustodiesController : ControllerBase
{
    private readonly IMediator _mediator;

    public StudentInventoryCustodiesController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllStudentInventoryCustodiesQuery());
    ...
    {
        var result = await _mediator.Send(new GetStudentInventoryCustodyByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateStudentInventoryCustodyCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateStudentInventoryCustodyCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteStudentInventoryCustodyCommand { Id = id });
