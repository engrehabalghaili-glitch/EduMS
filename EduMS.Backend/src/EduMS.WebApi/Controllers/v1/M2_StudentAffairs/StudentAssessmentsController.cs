...
public class StudentAssessmentsController : ControllerBase
{
    ...
    public StudentAssessmentsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllStudentAssessmentsQuery());
    ...
    {
        var result = await _mediator.Send(new GetStudentAssessmentByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateStudentAssessmentCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateStudentAssessmentCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteStudentAssessmentCommand { Id = id });
