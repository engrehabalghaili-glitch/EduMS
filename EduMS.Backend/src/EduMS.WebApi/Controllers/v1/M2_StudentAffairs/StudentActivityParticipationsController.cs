...
[Authorize]
public class StudentActivityParticipationsController : ControllerBase
{
    private readonly IMediator _mediator;

    public StudentActivityParticipationsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllStudentActivityParticipationsQuery());
    ...
    {
        var result = await _mediator.Send(new GetStudentActivityParticipationByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateStudentActivityParticipationCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateStudentActivityParticipationCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteStudentActivityParticipationCommand { Id = id });
