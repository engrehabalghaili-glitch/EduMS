...
[Authorize]
public class AssetWarrantyContractsController : ControllerBase
{
    private readonly IMediator _mediator;

    public AssetWarrantyContractsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllAssetWarrantyContractsQuery());
    ...
    {
        var result = await _mediator.Send(new GetAssetWarrantyContractByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateAssetWarrantyContractCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateAssetWarrantyContractCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteAssetWarrantyContractCommand { Id = id });
