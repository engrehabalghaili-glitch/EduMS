...
[Authorize]
public class AssetFinancialsesController : ControllerBase
{
    private readonly IMediator _mediator;

    public AssetFinancialsesController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllAssetFinancialsesQuery());
    ...
    {
        var result = await _mediator.Send(new GetAssetFinancialsByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateAssetFinancialsCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateAssetFinancialsCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteAssetFinancialsCommand { Id = id });
