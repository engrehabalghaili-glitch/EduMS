...
[Authorize]
public class AssetInspectionLogsController : ControllerBase
{
    private readonly IMediator _mediator;

    public AssetInspectionLogsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllAssetInspectionLogsQuery());
    ...
    {
        var result = await _mediator.Send(new GetAssetInspectionLogByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateAssetInspectionLogCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateAssetInspectionLogCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteAssetInspectionLogCommand { Id = id });
