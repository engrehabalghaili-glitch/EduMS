...
[Authorize]
public class FieldInventoryLogsController : ControllerBase
{
    private readonly IMediator _mediator;

    public FieldInventoryLogsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllFieldInventoryLogsQuery());
    ...
    {
        var result = await _mediator.Send(new GetFieldInventoryLogByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateFieldInventoryLogCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateFieldInventoryLogCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteFieldInventoryLogCommand { Id = id });
