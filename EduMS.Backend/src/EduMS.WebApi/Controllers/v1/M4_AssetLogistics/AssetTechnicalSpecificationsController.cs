...
[Authorize]
public class AssetTechnicalSpecificationsController : ControllerBase
{
    private readonly IMediator _mediator;

    public AssetTechnicalSpecificationsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllAssetTechnicalSpecificationsQuery());
    ...
    {
        var result = await _mediator.Send(new GetAssetTechnicalSpecificationByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateAssetTechnicalSpecificationCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateAssetTechnicalSpecificationCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteAssetTechnicalSpecificationCommand { Id = id });
