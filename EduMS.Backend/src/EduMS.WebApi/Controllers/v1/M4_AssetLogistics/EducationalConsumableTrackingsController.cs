...
[Authorize]
public class EducationalConsumableTrackingsController : ControllerBase
{
    private readonly IMediator _mediator;

    public EducationalConsumableTrackingsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllEducationalConsumableTrackingsQuery());
    ...
    {
        var result = await _mediator.Send(new GetEducationalConsumableTrackingByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateEducationalConsumableTrackingCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateEducationalConsumableTrackingCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteEducationalConsumableTrackingCommand { Id = id });
