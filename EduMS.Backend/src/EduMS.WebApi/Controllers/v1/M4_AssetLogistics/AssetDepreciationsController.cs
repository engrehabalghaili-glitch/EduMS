...
public class AssetDepreciationsController : ControllerBase
{
    ...
    public AssetDepreciationsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllAssetDepreciationsQuery());
    ...
    {
        var result = await _mediator.Send(new GetAssetDepreciationByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateAssetDepreciationCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateAssetDepreciationCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteAssetDepreciationCommand { Id = id });
