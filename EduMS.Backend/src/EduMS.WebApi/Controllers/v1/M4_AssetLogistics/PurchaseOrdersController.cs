...
public class PurchaseOrdersController : ControllerBase
{
    ...
    {
        var id = await _mediator.Send(new CreatePurchaseOrderCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdatePurchaseOrderCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeletePurchaseOrderCommand { Id = id });
