...
[Authorize]
public class AssetLocationRecordsController : ControllerBase
{
    private readonly IMediator _mediator;

    public AssetLocationRecordsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllAssetLocationRecordsQuery());
    ...
    {
        var result = await _mediator.Send(new GetAssetLocationRecordByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateAssetLocationRecordCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateAssetLocationRecordCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteAssetLocationRecordCommand { Id = id });
