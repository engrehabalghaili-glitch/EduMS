...
[Authorize]
public class AssetLoanTrackingAlertsController : ControllerBase
{
    private readonly IMediator _mediator;

    public AssetLoanTrackingAlertsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllAssetLoanTrackingAlertsQuery());
    ...
    {
        var result = await _mediator.Send(new GetAssetLoanTrackingAlertByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateAssetLoanTrackingAlertCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateAssetLoanTrackingAlertCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteAssetLoanTrackingAlertCommand { Id = id });
