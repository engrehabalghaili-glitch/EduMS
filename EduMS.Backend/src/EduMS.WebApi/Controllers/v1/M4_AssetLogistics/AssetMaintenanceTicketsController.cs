...
[Authorize]
public class AssetMaintenanceTicketsController : ControllerBase
{
    private readonly IMediator _mediator;

    public AssetMaintenanceTicketsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllAssetMaintenanceTicketsQuery());
    ...
    {
        var result = await _mediator.Send(new GetAssetMaintenanceTicketByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateAssetMaintenanceTicketCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateAssetMaintenanceTicketCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteAssetMaintenanceTicketCommand { Id = id });
