...
[Authorize]
public class AssetAuditFinalApprovalsController : ControllerBase
{
    private readonly IMediator _mediator;

    public AssetAuditFinalApprovalsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllAssetAuditFinalApprovalsQuery());
    ...
    {
        var result = await _mediator.Send(new GetAssetAuditFinalApprovalByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateAssetAuditFinalApprovalCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateAssetAuditFinalApprovalCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteAssetAuditFinalApprovalCommand { Id = id });
