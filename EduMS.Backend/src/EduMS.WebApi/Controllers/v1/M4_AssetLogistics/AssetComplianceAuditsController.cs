...
[Authorize]
public class AssetComplianceAuditsController : ControllerBase
{
    private readonly IMediator _mediator;

    public AssetComplianceAuditsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllAssetComplianceAuditsQuery());
    ...
    {
        var result = await _mediator.Send(new GetAssetComplianceAuditByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateAssetComplianceAuditCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateAssetComplianceAuditCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteAssetComplianceAuditCommand { Id = id });
