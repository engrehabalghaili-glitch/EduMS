...
public class MaintenanceNotificationsController : ControllerBase
{
    ...
    public MaintenanceNotificationsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllMaintenanceNotificationsQuery());
    ...
    {
        var result = await _mediator.Send(new GetMaintenanceNotificationByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateMaintenanceNotificationCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateMaintenanceNotificationCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteMaintenanceNotificationCommand { Id = id });
