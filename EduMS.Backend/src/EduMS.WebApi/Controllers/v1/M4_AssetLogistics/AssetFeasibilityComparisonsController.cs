...
[Authorize]
public class AssetFeasibilityComparisonsController : ControllerBase
{
    private readonly IMediator _mediator;

    public AssetFeasibilityComparisonsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllAssetFeasibilityComparisonsQuery());
    ...
    {
        var result = await _mediator.Send(new GetAssetFeasibilityComparisonByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateAssetFeasibilityComparisonCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateAssetFeasibilityComparisonCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteAssetFeasibilityComparisonCommand { Id = id });
