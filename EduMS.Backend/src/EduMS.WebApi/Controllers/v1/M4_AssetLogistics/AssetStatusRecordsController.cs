...
[Authorize]
public class AssetStatusRecordsController : ControllerBase
{
    private readonly IMediator _mediator;

    public AssetStatusRecordsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllAssetStatusRecordsQuery());
    ...
    {
        var result = await _mediator.Send(new GetAssetStatusRecordByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateAssetStatusRecordCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateAssetStatusRecordCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteAssetStatusRecordCommand { Id = id });
