...
[Authorize]
public class CommunityPartnershipsController : ControllerBase
{
    private readonly IMediator _mediator;

    public CommunityPartnershipsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllCommunityPartnershipsQuery());
    ...
    {
        var result = await _mediator.Send(new GetCommunityPartnershipByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateCommunityPartnershipCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateCommunityPartnershipCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteCommunityPartnershipCommand { Id = id });
