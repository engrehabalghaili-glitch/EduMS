...
[Authorize]
public class SchoolDeficitsController : ControllerBase
{
    private readonly IMediator _mediator;

    public SchoolDeficitsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var result = await _mediator.Send(new GetAllSchoolDeficitsQuery());
    ...
    {
        var result = await _mediator.Send(new GetSchoolDeficitByIdQuery { Id = id });
    ...
    {
        var id = await _mediator.Send(new CreateSchoolDeficitCommand { Dto = dto });
    ...
    {
        dto.Id = id;
        var result = await _mediator.Send(new UpdateSchoolDeficitCommand { Dto = dto });
    ...
    {
        var result = await _mediator.Send(new DeleteSchoolDeficitCommand { Id = id });
